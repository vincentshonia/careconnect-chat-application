...
- [ ] Dashboard V2 role scoping
- [ ] Waiting/Escalated filter vocabulary matches SQL
...
- [ ] Server-side pagination/search/filters: Staff, Inbox, Contacts, Intake, drill-downs
- [ ] Remove `.limit(100/200/2000)` client-side aggregation patterns
