# CareConnect staff manual — Team Lead

_Keep the queue moving and the team balanced._

**Who this is for:** Supervisors responsible for a department's day-to-day service.
...
**You do everything a Standard User does, plus you decide who works what. Transfers, reassignments and queue health are yours.**
...
### 12.2 Filtering and date ranges
...
### 13.3 Roles, departments and capacity
...
### 13.4 Disabling and removing access
...
### 14.2 Desktop and device alerts
...
### 14.3 Choosing what reaches you
...
### 15.2 Availability and appearance
...
1. A conversation belongs to the wrong team. What is the correct action?

   A. Close it
   B. Transfer it to the right department
   C. Reply anyway
   D. Delete it

   *Answer: B — Transfer moves it to another department's queue and notifies that department. Reassign moves it to a person within the department.*

2. In the Reassign dialog a teammate is listed but greyed out. Why?

   A. They are on holiday
   B. They are ineligible — offline, at capacity, or not in this department — and the reason is shown
   C. They have no photo
   D. The list is broken

   *Answer: B — Only active, in-department staff with spare capacity are eligible. Overrides require a written reason, which is recorded.*

3. An unassigned conversation needs a reply and you are a supervisor. Can you type straight into it?

   A. Yes, supervisors bypass ownership
   B. No — it must be claimed or assigned to someone first
   C. Only in the Closed tab
   D. Only after exporting it

   *Answer: B — Ownership is enforced for everyone. Claim it yourself or assign it, then reply.*

4. Your department's Oldest waiting figure is climbing and nobody is Available. What first?

   A. Wait for the next shift
   B. Rebalance: reassign to someone with capacity, or claim the oldest conversation yourself
   C. Close the waiting conversations
   D. Change the SLA target

   *Answer: B — Waiting time is the visitor's experience. Move work to available capacity or take it yourself.*

5. You need to coach someone about a low rating. Where do you discuss it?

   A. In the team channel
   B. Privately with the individual, using the transcript as evidence
   C. In the conversation with the visitor
   D. In a knowledge article

   *Answer: B — Individual performance is coached privately. Review transcripts inside the platform, never by copying them out.*
