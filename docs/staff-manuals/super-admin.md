# CareConnect staff manual — Super Admin

_Highest authority in the organization: administrators, security and tenants._

**Who this is for:** The small group accountable for CareConnect as a whole.
...
19. Security
20. Audit log
21. Organizations & brands
22. Notifications
23. My settings
24. Privacy, safety and the audit trail
25. When something looks wrong
26. Words CareConnect uses
27. Common mistakes and your final checklist
28. Knowledge check
...
**You hold everything an Administrator holds, plus the three powers nobody else has: managing other administrators, setting authentication policy, and managing organizations and brands.**
...
### 19.1 Two-step verification policy
...
### 21.1 Organizations, brands and websites
...
### 23.2 Availability and appearance
...
### 24.1 Handling protected health information
...
### 24.2 Emergencies and crisis language
...
### 25.1 Common problems and their fixes
...
### 26.2 Conversation and request statuses
...
1. Who may create or change another administrator?

   A. Any administrator
   B. Only the highest administrative level
   C. Any manager
   D. Anyone with staff.view

   *Answer: B — Administering administrators is deliberately reserved, and the system refuses to remove the last administrator of an organization.*

2. You switch two-step verification to “required for everyone”. What should you do first?

   A. Nothing, it is seamless
   B. Announce it in advance and make sure someone can help with lockouts
   C. Disable all accounts
   D. Reset every password

   *Answer: B — Affected staff cannot sign in until they enrol. Warn them and staff the support path.*

3. Can data move between two organizations on the platform?

   A. Yes, with an export
   B. No — tenant isolation is enforced in the database, not just the interface
   C. Only for administrators
   D. Only for knowledge articles

   *Answer: B — Conversations, knowledge, contacts, staff and settings never cross a tenant boundary.*

4. You enter another organization for a support task. What is true?

   A. Your actions are anonymous
   B. Every action is attributed to you in that tenant's audit log
   C. The audit log is skipped for platform roles
   D. You must disable logging first

   *Answer: B — Platform access exists for justified support work, and it is fully attributed.*

5. What is the minimum safe administrator count per organization?
   ...
   *Answer: B — A single administrator is a lockout waiting to happen; the system also refuses to remove the last one.*
