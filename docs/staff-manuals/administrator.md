...
### 21.3 Desktop and device alerts
...
### 21.4 Choosing what reaches you
...
1. You add a staff member. What does CareConnect send them?

   A. A temporary password
   B. A single-use invitation link that expires after 7 days
   C. Nothing — they sign up themselves
   D. Their password, stored in the audit log

   *Answer: B — CareConnect never emails passwords. The invitation link is single use, tied to that email address, and expires.*
