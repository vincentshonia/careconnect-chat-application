# CareConnect staff manual — Manager

_Own the answers the assistant gives and the outcomes the team produces._

**Who this is for:** Managers accountable for service quality and knowledge accuracy.
...
15. Notifications
16. My settings
17. Privacy, safety and the audit trail
18. When something looks wrong
19. Words CareConnect uses
20. Common mistakes and your final checklist
21. Knowledge check
...
**You own what the assistant says and how well the work is done. Knowledge, workflow and quality sit with you; platform configuration does not.**
...
> **Interface illustration — Dashboard — Team Lead and Manager view**
>
> Team-scoped dashboard adding department queue health, staff availability and a team workload table below the personal panels.
>
> 1. Your personal counters stay at the top — you are still an owner of conversations.
> 2. Staff availability — live presence counts for the people in your departments.
> 3. My departments — queue health per department: open, waiting, oldest waiting, SLA risk, CSAT.
> 4. My team today — presence, live workload and outcomes per teammate. Selecting a row opens the full report.
...
Each counter is a shortcut: selecting it opens the Inbox filtered to exactly those conversations.
...
### 14.3 Roles, departments and capacity
...
### 14.4 Disabling and removing access
...
### 15.2 Desktop and device alerts
...
### 15.3 Choosing what reaches you
...
### 16.2 Availability and appearance
...
### 17.1 Handling protected health information
...
### 17.2 Emergencies and crisis language
...
### 18.1 Common problems and their fixes
...
### 19.2 Conversation and request statuses
...
1. The assistant gave a confident but wrong answer. What is the fix?

   A. Tell staff to correct visitors afterwards
   B. Reproduce it in the AI console, then correct or unpublish the article behind it
   C. Turn the assistant off
   D. Add the correction to a response template only

   *Answer: B — The assistant answers from published articles. Fix the source and the answer changes for everyone.*

2. Which content belongs in a knowledge article?

   A. A one-off policy exception
   B. Approved, general guidance you would be happy to see quoted verbatim
   C. Staff direct phone numbers
   D. Internal ticket references

   *Answer: B — Published articles are quoted to visitors. Exceptions and internal details never belong there.*

3. What happens the moment you publish an article?

   A. Nothing until a nightly rebuild
   B. It becomes available to the assistant immediately
   C. An administrator must approve it
   D. It only appears in Reports

   *Answer: B — Publishing is live. Draft while you work and publish only when the content is correct.*

4. Testing a question in the AI console does what?

   A. Creates a real conversation
   B. Notifies the department
   C. Nothing visitor-facing — it is a safe test
   D. Publishes a new article

   *Answer: C — The console is for testing. It never reaches a visitor and creates no conversation.*

5. A report figure differs from a colleague's for the same day. Most likely cause?

   A. A bug
   B. Different reach — their role scopes the data differently — or a different timezone assumption
   C. The export was capped
   D. The assistant changed the data

   *Answer: B — Reports are scoped to what each role may see, and all dates use the organization's timezone.*
