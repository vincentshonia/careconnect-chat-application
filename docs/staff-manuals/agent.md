# CareConnect staff manual — Standard User

_Answer visitors, capture referrals, keep records clean._

**Who this is for:** Front-line staff who handle website chats and intake requests.
...
11. Notifications
12. My settings
13. Privacy, safety and the audit trail
14. When something looks wrong
15. Words CareConnect uses
16. Common mistakes and your final checklist
17. Knowledge check
...
**You are the person a visitor reaches when the assistant cannot finish the job. Your work is to answer clearly, capture what is needed, and finish every conversation properly.**
...
> **Interface illustration — Dashboard — Standard User view**
>
> Dashboard for a standard user showing a greeting with role badge and availability selector, personal counters, the Needs my attention panel and the Available conversations queue.
>
> 1. Greeting, your role badge, and the Availability selector (Available, Busy, Away, Offline).
> 2. Right now — your own live counters plus what is waiting in your departments.
> 3. Needs my attention — ordered by urgency: waiting visitors, SLA risk, escalations, follow-ups.
> 4. My performance — your numbers for the selected period, with a period selector.
> 5. Available conversations — waiting visitors you are eligible to claim, each with a Claim button.
...
### 11.2 Desktop and device alerts
...
### 11.3 Choosing what reaches you
...
### 12.2 Availability and appearance
...
### 13.1 Handling protected health information
...
### 13.2 Emergencies and crisis language
...
### 14.1 Common problems and their fixes
...
### 15.2 Conversation and request statuses
...
1. A conversation is in the Waiting tab and you want to reply. What must you do first?

   A. Just type in the reply box
   B. Select Claim conversation
   C. Transfer it to your department
   D. Mark it resolved

   *Answer: B — Unassigned conversations have no reply box. Claiming makes you the owner, and only the owner may reply.*

2. Your claim fails with “Could not claim this conversation”. What happened?

   A. The visitor left
   B. You are signed out
   C. Someone claimed it first, or you are at your capacity limit
   D. The conversation was deleted

   *Answer: C — Claims are first-come, first-served and capacity-aware. Move on to the next waiting item.*

3. A visitor says they are in immediate danger. What do you do?

   A. Transfer the chat and move on
   B. Stay with them, repeat the emergency guidance including calling 911, and escalate to a supervisor
   C. Close the conversation
   D. Give first-aid instructions

   *Answer: B — CareConnect is not a clinical tool. Stay present, repeat the emergency guidance and escalate immediately.*

4. The chat is over but the visitor's need was not met. Which action is correct?
   ...
   *Answer: B — Resolve means the need was met; Close means finished without a resolution. Reporting depends on the difference.*

5. Where may you record notes about a member?

   A. A personal spreadsheet
   B. Staff notes on the contact record in CareConnect
   C. A team messaging app
   D. Your own email

   *Answer: B — Member information stays inside CareConnect, where access is controlled and every change is logged.*
