  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        {
          kind: "p",
          text: "Navigation is grouped into Workspace (day-to-day work), Content & AI (what the assistant knows and how well the team performs) and Admin (one page of tabs that controls how the platform behaves). You only see items your role allows — the list below marks who sees what.",
        },
        {
          kind: "table",
